...
auto aoc::day3::sum_item_priorities_of_both_compartments(std::span<const std::string> lines) -> int{
...
auto aoc::day3::sum_grouped_item_priorities_of_both_compartments(std::span<const std::string> lines) -> int{
