...
auto operation(const std::string &op, const aoc2022::day11::Item &a, const aoc2022::day11::Item &b) -> aoc2022::day11::Item {
    if (op == "*") {
        return a * b;
    } else if (op == "+") {
        return a + b;
...
auto aoc2022::day11::parse_input(std::string data) -> Monkeys {
    Monkeys monkeys{};
...
void aoc2022::day11::simulate_rounds(Monkeys &monkeys, unsigned n_rounds) {
...
void aoc2022::day11::set_normalised_worry(Monkeys &monkeys) {
...
auto aoc2022::day11::top_two_monkey_business(aoc2022::day11::Monkeys &monkeys) -> long long int {
    std::ranges::sort(monkeys, std::greater{}, &Monkey::counter);
    return monkeys[0].counter() * monkeys[1].counter();
}

aoc2022::day11::Monkey::Monkey(std::string &&monkey_str) {
...
void aoc2022::day11::Monkey::init_test(std::istringstream &stream, std::istringstream &line_stream) {
...
void aoc2022::day11::Monkey::init_operation(std::istringstream &line) {
...
void aoc2022::day11::Monkey::init_starting_items(std::istringstream &line) {
...
void aoc2022::day11::Monkey::inspect_all_items() {
    counter_ += items.size();
    std::ranges::transform(items, items.begin(), update_item_);
    std::ranges::transform(items, items.begin(), normalise_item_);
}

auto aoc2022::day11::Monkey::counter() const -> long long int { return counter_; }

void aoc2022::day11::Monkey::set_worry_normaliser(std::function<Item(Item)> &&normaliser) { normalise_item_ = std::move(normaliser); }

auto aoc2022::day11::Monkey::test_divisor() const -> long long int { return test_divisor_; }
