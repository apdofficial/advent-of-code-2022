...
auto aoc2022::day05::parse_input(std::istream &is) -> std::pair<std::vector<Command>, std::vector<std::vector<char>>> {
...
auto aoc2022::day05::execute_crane_9000(std::vector<std::vector<char>> &stacks, const std::vector<Command> &commands) -> void {
...
auto aoc2022::day05::execute_crane_9001(std::vector<std::vector<char>> &stacks, const  std::vector<Command> &commands) -> void {
    for (const auto &[crate, from, to]: commands) {
